...
class Control(Node):
    def __init__(self):
        ...
        self.led_timer = self.create_timer(3, self.led_timer_callback)
        self.led_state = Bool()
    ...
    def led_timer_callback(self):
        ...
        self.get_logger().info(f"Publishing: {self.led_state}")
